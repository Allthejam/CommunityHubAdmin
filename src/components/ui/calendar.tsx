  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekdays: "flex",
        weekday: "text-muted-foreground rounded-md w-9 font-normal text-[0.8rem] flex items-center justify-center h-9",
        ...
        dropdowns: "flex justify-center gap-1 items-center px-8",
        dropdown: "rdp-dropdown bg-transparent text-xs font-bold uppercase focus-visible:outline-none cursor-pointer hover:text-primary",
        ...classNames,
      }}
      components={{
        Chevron: (props) => {
